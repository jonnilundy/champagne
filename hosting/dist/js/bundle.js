...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $guestlist(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('thead');
      ie_open('th', null, null, 'class', 'first_name');
      itext('First');
      ie_close('th');
      ie_open('th', null, null, 'class', 'last_name');
      itext('Last');
      ie_close('th');
      ie_open('th', null, null, 'class', 'attending');
      itext('Attending');
      ie_close('th');
      ie_open('th', null, null, 'class', 'plus_one');
      itext('Plus One');
      ie_close('th');
      ie_open('th', null, null, 'class', 'gluten');
      itext('Gluten-Free');
      ie_close('th');
      ie_open('th', null, null, 'class', 'dairy');
      itext('Dairy-Free');
      ie_close('th');
      ie_close('thead');
