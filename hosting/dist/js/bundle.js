...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('div', null, null, 'class', 'outer-wrapper');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $details(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('h2');
      itext('You\'re invited to our wedding');
      ie_close('h2');
      ie_open('h2');
      itext('June 10th, 2017');
      ie_close('h2');
      ie_open('h2');
      itext('West Covina, CA');
      ie_close('h2');
      ...
      ie_close('h2');
      ie_open('p');
      itext('The estate has limited parking so please carpool as much as possible. If you would like to know if others are coming from your area or volunteer to park at a remote location and get shuttled to the venue, please contact Jonni (503.858.753) or mention it in your RSVP.');
      ie_close('p');
      ie_close('div');
      ie_close('div');
      ie_close('div');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $login(opt_data, opt_ignored, opt_ijData) {
      ...
      itext('Email');
      ie_close('label');
      ie_open('input', null, null, 'type', 'email', 'placeholder', 'youremail@company.com', 'class', 'form-control', 'name', 'email', 'value', '', 'maxlength', '100', 'autofocus', '', 'required', '');
      ie_close('input');
      ie_close('div');
      ie_open('div', null, null, 'class', 'form-group');
      ie_open('div', null, null, 'class', 'col-flex-row-spacebetween-center');
      ie_open('label');
      itext('Password');
      ie_close('label');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $mojo(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('div', null, null, 'class', 'container container-fluid');
      ie_close('div');
      ie_void('footer');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $rsvp(opt_data, opt_ignored, opt_ijData) {
      ...
      itext('Email Address');
      ie_close('label');
      ie_open('input', null, null, 'type', 'text', 'id', 'email', 'name', 'email', 'placeholder', 'yourname@email.com');
      ie_close('input');
      ie_close('div');
      ie_open('div', null, null, 'class', 'form-group');
      ie_open('label');
      ...
      ie_close('label');
      ie_open('div', null, null, 'class', 'attend-container');
      ie_open('input', null, null, 'type', 'radio', 'name', 'attend', 'id', 'accept', 'value', 'Yes', 'onclick', 'toggle-visibility(\'attending-show\');', 'checked', '');
      ie_close('input');
  ...
  var rsvp = function (_Component) {
    ...
    function rsvp() {
      babelHelpers.classCallCheck(this, rsvp);
      return babelHelpers.possibleConstructorReturn(this, (rsvp.__proto__ || Object.getPrototypeOf(rsvp)).apply(this, arguments));
    }
